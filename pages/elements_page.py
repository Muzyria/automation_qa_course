...
class UploadAndDownload(BasePage):
    ...
    def upload_file(self):
        ...
        # print(os.path.basename(text), os.path.basename(file_name), sep="\n")
        return os.path.basename(file_name), os.path.basename(text)

    @allure.step('download file')
    def download_file(self):
        link = self.element_is_present(self.locators.DOWNLOAD_FILE).get_attribute("href")
        link_b = base64.b64decode(link)
        path_name_file = rf'{os.getcwd()}\filetest{random.randint(0, 999)}.jpg'
