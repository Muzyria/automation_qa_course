...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.element_is_visible(self.locators.STATE_INPUT).send_keys(Keys.RETURN)  # poptom dobaviti random STATE
        self.element_is_visible(self.locators.SELECT_CITY).click()
        self.element_is_visible(self.locators.CITY_INPUT).send_keys(Keys.RETURN)  # poptom dobaviti random CITY
